...
| **🎨 Personalização & Mobile UI** | Tema predefinido **🌿 Camomila Oficial** (inspirado em <a href="https://www.camomilasbe.pt/">camomilasbe.pt</a> com Verde Sálvia `#498b7c`, Amarelo `#f2d549` e botões *pill-style* arredondados), 5 temas alternativos e barra de navegação móvel. | [📘 Ver Guia](./docs/USER_MANUAL.md#5-personaliza%C3%A7%C3%A3o-visual--experi%C3%AAncia-mobile) |
